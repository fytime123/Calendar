...
public abstract class ProgressManager {
	...
	protected ProgressManager(CollapseCalendarView calendarView, int activeWeek, boolean fromMonth) {
...
//		mCalendarView.getParent().requestLayout();
//		mCalendarView.getParent().getParent().requestLayout();
